...
if __name__ == '__main__':
    ...
    for i in range(n_iter):
        ...
        x_diff = a * y_new - a * x_new
        y_diff = c * x_new - y_new - x_new * z_new
        z_diff = x_new * y_new - b * z_new

        x_new = 1 / 2 * x_old + 1 / 2 * (x_new + dt * x_diff)
        y_new = 1 / 2 * y_old + 1 / 2 * (y_new + dt * y_diff)
        z_new = 1 / 2 * z_old + 1 / 2 * (z_new + dt * z_diff)
